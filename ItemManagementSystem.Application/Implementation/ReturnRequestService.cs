...
public class ReturnRequestService : IReturnRequestService
{
        ...
        IRepository<User> userRepo)
    {
        ...
        public async Task<PagedResultDto<ItemManagementSystem.Domain.Dto.Return.ReturnRequestResponseDto>> GetAllReturnRequestsAsync(ReturnRequestFilterDto filter)
        {
            ...
            foreach (var entity in paged.Items)
            {
                ...
                var itemDtos = items.Select(i => new ItemManagementSystem.Domain.Dto.Return.ReturnRequestItemResponseDto
                {
                    Quantity = i.Quantity,
    ...
    private static string GenerateReturnRequestNumber()
    {
        ...
        public async Task<ReturnRequestDto> CreateReturnRequestAsync(int userId, ReturnRequestCreateDto dto)
        {
            ...
            // Check if all items exist and are not deleted
    ...
    public async Task UpdateReturnRequestStatusAsync(int id, string status, string? comment, int userId)
    {
        ...
        public async Task EditReturnRequestAsync(int id, int userId, ReturnRequestCreateDto dto)
        {
            ...
            // Remove items not in dto.Items from database
            ...
            foreach (var existingItem in existingItems)
            {
                ...
                {
                    await _returnRequestItemRepo.DeleteAsync(existingItem);
                }
            }
